"""
Comprehensive API Tests for Delivery-Bot
...
class TestAPIEndpoints:
    ...
    def test_create_pipeline_invalid_step_validation(self):
        ...
        payload = {
            ...
            "repo_url": "https://github.com/example/repo",
            "steps": [
                {"name": "test", "type": "invalid_type", "command": "echo"}
            ]
        }
    ...
    def test_update_pipeline_success(self, mock_create_workflow):
        ...
        update_payload = {
            ...
            "steps": [
                ...
                {"name": "build", "type": "build", "dockerfile": "Dockerfile", "ecr_repo": "app/backend"}
            ]
        }
    ...
    def test_trigger_pipeline_with_github_integration(self, mock_settings):
        ...
        with patch('api.gh.create_and_merge_workflow_pr') as mock_create_workflow, \
    ...
    def test_pipeline_update_with_step_changes(self, mock_create_workflow):
        ...
        initial_payload = {
            ...
            "repo_url": "https://github.com/example/repo",
            "steps": [
                {"name": "old-step", "type": "run", "command": "echo old"}
            ]
        }
        ...
        update_payload = {
            ...
            "steps": [
                ...
                {"name": "new-step-2", "type": "build", "dockerfile": "Dockerfile", "ecr_repo": "app/backend"}
            ]
        }
